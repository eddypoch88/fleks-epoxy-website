export const translations = {
  en: {
    ...
    pricing: {
      ...
      f1: ["1–2 day install", "Seamless & easy to clean", "5-year warranty", "10 colour options", "Free design consult"],
  ...
  ms: {
    ...
    pricing: {
      ...
      f1: ["Siap 1-2 hari", "Tiada sambungan & mudah dicuci", "Jaminan 5 tahun", "10 pilihan warna", "Konsultasi rekaan percuma"],
  ...
  zh: {
    ...
    pricing: {
      ...
      f1: ["1-2天安装", "无缝且易于清洁", "5年保修", "10种颜色选择", "免费设计咨询"],
